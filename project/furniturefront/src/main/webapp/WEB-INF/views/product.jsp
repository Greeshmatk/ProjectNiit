...
<!--   <meta charset="utf-8">
  ...
  .controller('mainController', function($scope) {
    ...
    $scope.sushi = [
      { name: 'FARIC SOFA SETS', fish: 'SOFA' },
      { name: '6 SEATS DINING TABLES', fish: 'DINING TABLE' },
      { name: 'COMPUTER TABLE AND STUDY TABLE', fish: 'STUDY TABLE' },
      { name: 'DOUBLE BEDS', fish: 'BED'}
    ];
...
<%@ page session="false"%>
<%@ page isELIgnored="false"%><title>Products|Phonaholic</title>
