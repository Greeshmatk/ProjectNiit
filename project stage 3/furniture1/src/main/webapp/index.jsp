            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active">
                        <img src="/src/main/webapp/resources/images/image1.jpg"  style="width:100%" data-src="holder.js/600x300/auto/#7cbf00:#fff/text: " alt="First slide">
                    ...
                    <div class="item">
                        <img src="/src/main/webapp/resources/images/image2.jpg" style="width:100%" data-src="holder.js/600x300/auto/#7cbf00:#fff/text: " alt="Second slide">
                        <div class="carousel-caption">
                            <h3>
                    ...
                    <div class="item">
                        <img src="/src/main/webapp/resources/images/image3.jpg" style="width:100%" data-src="holder.js/600x300/auto/#7cbf00:#fff/text: " alt="Third slide">
                        <div class="carousel-caption">
                            <h3>
					...
					<div class="item">
                        <img src="/src/main/webapp/resources/images/image4.jpg" style="width:100%" data-src="holder.js/600x300/auto/#7cbf00:#fff/text: " alt="Fourth slide">
                        <div class="carousel-caption">
                            <h3>
...
v class="container-fluid bg-3 text-center">
   <div class="row">
	...
	<h3>Dining Room</h3>
	<h4>DINE IN STYLE</h4>
      <img src="/src/main/webapp/resources/images/dining.jpg" class="img-responsive margin" style="width:100%" alt="Image">
    </div>
    <div class="col-sm-3">
	<h3>Bed Room</h3>
	<h4>INNER SANCTUM</h4>
      <img src="/src/main/webapp/resources/images/bed.jpg" class="img-responsive margin" style="width:100%" alt="Image">
    </div>
    <div class="col-sm-3">
	<h3>Study Room</h3>
	<h4>LIVING IT UP</h4>
		<img src="/src/main/webapp/resources/images/study.jpg" class="img-responsive margin" style="width:100%" alt="Image">
    </div>
	<div class="col-sm-3">
	<h3>Living Room</h3>
	<h4>WORKING IT</h4>
      <img src="/src/main/webapp/resources/images/living.jpg" class="img-responsive margin" style="width:100%" alt="Image">
    </div>
  </div>
</div>
