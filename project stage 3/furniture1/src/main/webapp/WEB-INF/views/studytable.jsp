    ...
    <div class="row">
        <div class="col-md-12">
			...
			<div class="col-xs-12 col-sm-6 col-md-3">
				<div class="thumbnail" >
					<img src="Terry_Study_Table_Golden.jpg" class="img-responsive">
					<div class="caption">
						<div class="row">
			...
			<div class="col-xs-12 col-sm-6 col-md-3">
    			<div class="thumbnail" >
					<img src="Tolstoy_Study_Table.jpg" class="img-responsive">
					<div class="caption">
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-4 price">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
    			<div class="thumbnail" >
					<img src="LP_Barrie_Study_Table.jpg" class="img-responsive">
					<div class="caption">
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-4 price">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
    			<div class="thumbnail" >
					<img src="Bradbury_Desk_Teak_Finish.jpg" class="img-responsive">
					<div class="caption">
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-4 price">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
    			<div class="thumbnail" >
					<img src="Vector_Study_Table_Mahogany.jpg" class="img-responsive">
					<div class="caption">
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-4 price">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
    			<div class="thumbnail" >
					<img src="Eddings_Study_Table_Natural.jpg" class="img-responsive">
					<div class="caption">
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-4 price">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
    			<div class="thumbnail" >
					<img src="Terry_Study_Table_Wenge.jpg" class="img-responsive">
					<div class="caption">
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-4 price">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
    			<div class="thumbnail" >
					<img src="Austen_Compact_Desk_Two_Tone_Finish.jpg" class="img-responsive">
					<div class="caption">
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-4 price">
    							<h3 style="margin:5px auto;"><label>8,999</label></h3>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
    			<div class="thumbnail" >
					<img src="fonteyn.jpg" class="img-responsive">
					<div class="caption">
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-4 price">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
    			<div class="thumbnail" >
					<img src="Baxter_Folding_Study_dining_Table.jpg" class="img-responsive">
					<div class="caption">
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-4 price">
    							<h3 style="margin:5px auto;"><label>11,999</label></h3>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
    			<div class="thumbnail" >
					<img src="Douglas_Study_Table_Wenge.jpg" class="img-responsive">
					<div class="caption">
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-4 price">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
    			<div class="thumbnail" >
					<img src="Niccol_Adjustable_Study_Table.jpg" class="img-responsive">
					<div class="caption">
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-4 price">
